...
namespace TollCents.Api.Controllers
{
    ...
    public class RouteInformationController(ITollInformationGateway tollInformationGateway) : ControllerBase
    {
        private readonly ITollInformationGateway _tollInformationGateway = tollInformationGateway;
